                                        ...
                                        <div class="cart-totals-fields">
											...
											<tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="text-color" name="total_price"><strong> <?php echo "$".$totalPrice; ?></strong></td>
                                                    </tr>
                                                </tbody>
                                            </table>
                                        </div>
                                        ...
                                        <ul class=" list-unstyled">
                                            <li>
                                                <label class="custom-control custom-radio  m-b-20">
                                                    <input name="mod" id="radioStacked1" checked value="COD" type="radio" class="custom-control-input"> <span class="custom-control-indicator"></span> <span class="custom-control-description">Pay With Solflare Wallet</span>
                                                </label>
                                            </li>
                                            <li>
                                                <label class="custom-control custom-radio  m-b-20">
                                                    <input name="mod" id="radioStacked1" checked value="COD" type="radio" class="custom-control-input"> <span class="custom-control-indicator"></span> <span class="custom-control-description">Pay With Panthom Wallet</span><span class="custom-control-description"> <img src="images/bitcoin.png" alt="" width="30" height="30"></span>
                                                </label>
                                            </li>
                                        </ul>
                                        <!-- This Button Will Connect The Wallet -->
                                        <button onclick="connectWallet()" class="btn btn-primary mt-3">Connect Solflare Wallet</button>
                                        <!-- Make The Payment Onclick -->
                                        <p class="text-xs-center"> <input onclick="sendPayment(<?php echo $commissionAmount; ?>, <?php echo $sellerAmount; ?>)" type="submit" name="submit"  class="btn btn-success btn-block" value="Order Now"> </p>
                                    </div>
						<!-- </form> -->
                                </div>
                            </div>
                        ...
                        <div class="container">
                            <div class="row">
                                ...
                                <div class="col-xs-12 col-sm-4 address color-gray">
                                    <h5>Radar Hackathon</h5>
                                    <p>SuperteamNg</p>
                                    <h5>SuperteamNg Borno</a></h5>
                                </div>
                            </div>
                        </div>
                    </div>
